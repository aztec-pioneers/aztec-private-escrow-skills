...
This repo contains Claude Code skills for building private escrow contracts and TypeScript SDKs on Aztec Network.
...
Ask Claude to build a private escrow contract package on Aztec. The `scaffold-escrow-project` skill will be triggered automatically.
